...
CONSOLE_SCREEN_BUFFER_INFO GetWidthHeight(short *width, short *height)
{
    static HANDLE h = NULL;
    if (!h)
    {
...
void PrintVecStr(vector<string> texts, DirectionType direction, char charForHorizontal)
{
...
// for exit page
vector<string> FarewellText(int whichOne)
{
    short width, height;
    CONSOLE_SCREEN_BUFFER_INFO csbi = GetWidthHeight(&width, &height);
...
vector<string> CreateButton(string text, int horizontalPadding, int horizontalMargin, int verticalMargin)
{
    vector<string> texts;
    string temp;
...
void LoadingAnimation(string loadingText)
{
    cout << endl;
    cout << loadingText;
